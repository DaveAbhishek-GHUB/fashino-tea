...
function Oolongtea() {
  ...
  // Get the logged-in user status from the Redux store
      ...
      <div className="main-wrapper w-full h-screen mt-12">
        <div className="page-header-wrapper w-full h-[30vw] relative max-sm:h-[60vw]">
          <img
            ...
            src="https://www.paperandtea.com/cdn/shop/collections/collection_header-oolong_tea.jpg?v=1693400012&width=1800"
            alt="..."
          />
          <div className="page-heading-info-wrapper absolute bottom-[3vw] left-[3vw] w-[70vw]">
            <h1 className="text-[5vw] text-white font-serif max-sm:text-[8vw]">
              Oolong Tea
            </h1>
            <span className="text-[1.5vw] text-white max-sm:text-[3vw]">
              Savor centuries-old traditions with a cup of Oolong that unfolds
              its complex, multi-layered notes best in multiple infusions.
            </span>
          </div>
        </div>
        ...
        <div className="main-teainfo-wrapper w-full h-auto flex flex-col md:flex-row">
          ...
          <div className="ourblends w-full md:w-[50vw] h-auto md:h-full px-4 sm:px-[2vw] py-8 sm:py-[8vw] text-center md:text-left">
            ...
            <span className="text-[3vw] sm:text-[1.5vw] md:text-[1.2vw] font-sans text-[#9F9F9F] block mt-2">
              Our Origins bring the variety of our handcrafted premium
              whole-leaf teas and herbs. A flavorful journey through the world’s
              best tea-growing regions.
            </span>

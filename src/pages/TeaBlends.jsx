  ...
  return (
    <>
      ...
      <div className="main-wrapper w-full h-screen mt-12">
        ...
        {/* Section heading */}
        <div className="heading-wrapper w-full p-10 max-sm:p-5">
          <h1 className="text-[3.5vw] font-serif max-sm:text-[8vw]">Teas</h1>
          <span className="text-[1.6vw] font-extralight max-sm:text-[3vw]">
            ...
            TeaCollection.filter(
              ...
              .map((TeaData, index) => (
                ...
                >
                  ...
                  <Link to={`/Tea blend/${TeaData.product_id}`}>
